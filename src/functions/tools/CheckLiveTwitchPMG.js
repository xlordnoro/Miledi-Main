...
module.exports = async (client) => {
  ...
  async function sendLiveNotification(videoId) {
    ...
    const channel = await guild.channels.fetch('1069470438851350549').catch(console.error);
    if (channel) {
      await channel.send({ content: '@everyone <@&1054980965736398858> Pyle is now live on Twitch!', embeds: [liveEmbed], allowedMentions: { roles: ["1054980965736398858"] } });
    }
  }
